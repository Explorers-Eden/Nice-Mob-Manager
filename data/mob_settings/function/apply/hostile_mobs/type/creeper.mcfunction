...
execute if data storage eden:mob_settings creeper{drown:"disabled"} run tag @s add eden.settings.drown.disabled
execute if data storage eden:mob_settings creeper{burn:"disabled"} run attribute @s minecraft:burning_time base set 0
