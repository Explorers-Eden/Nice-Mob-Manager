...
execute if data storage eden:settings mob_settings.zombie_horse{breed:"disabled"} run tag @s add eden.settings.breed.disabled
execute if data storage eden:settings mob_settings.zombie_horse{drown:"disabled"} run tag @s add eden.settings.drown.disabled
execute if data storage eden:settings mob_settings.zombie_horse{burn:"disabled"} run attribute @s minecraft:burning_time base set 0
