...
$loot spawn ~ ~-64 ~ loot {"type":"minecraft:command","pools":[{"rolls":1,"entries":[{"type":"minecraft:item","name":"minecraft:player_head","modifier":[{"type":"minecraft:fill_player_head","entity":"this"},{"type":"minecraft:set_components","components":{"minecraft:custom_data":{"mob_manager":"playerheads_$(id)"}}}]}]}]}
