...
function mob_manager:villager_names/get_data/desert/copy_to_temp with storage eden:temp villager_names.desert.id

data modify storage eden:temp villager_names.desert.color set from storage eden:database color.villager.desert

function mob_manager:villager_names/set_name with storage eden:temp villager_names.desert