...
function mob_manager:villager_names/get_data/taiga/copy_to_temp with storage eden:temp villager_names.taiga.id

data modify storage eden:temp villager_names.taiga.color set from storage eden:database color.villager.taiga

function mob_manager:villager_names/set_name with storage eden:temp villager_names.taiga