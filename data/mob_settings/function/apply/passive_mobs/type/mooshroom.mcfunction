...
execute if data storage eden:mob_settings mooshroom{breed:"disabled"} run tag @s add eden.settings.breed.disabled
execute if data storage eden:mob_settings mooshroom{drown:"disabled"} run tag @s add eden.settings.drown.disabled
execute if data storage eden:mob_settings mooshroom{burn:"disabled"} run attribute @s minecraft:burning_time base set 0
