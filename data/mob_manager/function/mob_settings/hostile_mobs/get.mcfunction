...
execute if predicate {"condition":"minecraft:value_check","value":{"type":"minecraft:storage","storage":"eden:settings","path":"mob_manager.misc.illusionerspawning"},"range":{"min":0.01}} as @s[type=evoker] at @s run function mob_manager:illusioner with storage eden:settings mob_manager.misc
...
execute if predicate {"condition":"minecraft:value_check","value":{"type":"minecraft:storage","storage":"eden:settings","path":"mob_manager.mob_equipment.misc.mobheads"},"range":{"min":0.01}} as @s[type=#eden:valid_for_playerheads,type=!bogged] unless items entity @s armor.head * run function mob_manager:mob_equipment/mobheads/init with storage eden:settings mob_manager.mob_equipment.misc
execute if predicate {"condition":"minecraft:value_check","value":{"type":"minecraft:storage","storage":"eden:settings","path":"mob_manager.mob_equipment.misc.playerheads"},"range":{"min":0.01}} as @s[type=#eden:valid_for_playerheads] unless items entity @s armor.head * run function mob_manager:mob_equipment/playerheads/init with storage eden:settings mob_manager.mob_equipment.misc
