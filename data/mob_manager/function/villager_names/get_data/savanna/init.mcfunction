...
function mob_manager:villager_names/get_data/savanna/copy_to_temp with storage eden:temp villager_names.savanna.id

data modify storage eden:temp villager_names.savanna.color set from storage eden:database color.villager.savanna

function mob_manager:villager_names/set_name with storage eden:temp villager_names.savanna