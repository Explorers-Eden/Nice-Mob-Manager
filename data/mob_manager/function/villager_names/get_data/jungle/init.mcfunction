...
function mob_manager:villager_names/get_data/jungle/copy_to_temp with storage eden:temp villager_names.jungle.id

data modify storage eden:temp villager_names.jungle.color set from storage eden:database color.villager.jungle

function mob_manager:villager_names/set_name with storage eden:temp villager_names.jungle