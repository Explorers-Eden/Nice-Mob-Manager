...
function mob_manager:villager_names/get_data/plains/copy_to_temp with storage eden:temp villager_names.plains.id

data modify storage eden:temp villager_names.plains.color set from storage eden:database color.villager.plains

function mob_manager:villager_names/set_name with storage eden:temp villager_names.plains