...
function mob_manager:villager_names/get_data/snow/copy_to_temp with storage eden:temp villager_names.snow.id

data modify storage eden:temp villager_names.snow.color set from storage eden:database color.villager.snow

function mob_manager:villager_names/set_name with storage eden:temp villager_names.snow