...
function mob_manager:villager_names/get_data/deep_blue/copy_to_temp with storage eden:temp villager_names.deep_blue.id

data modify storage eden:temp villager_names.deep_blue.color set from storage eden:database color.villager.deep_blue

function mob_manager:villager_names/set_name with storage eden:temp villager_names.deep_blue