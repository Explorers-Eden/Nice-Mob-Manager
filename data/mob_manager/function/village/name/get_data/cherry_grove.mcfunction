...
$data modify storage eden:temp village_name.name set from storage eden:database names.village.cherry_grove.name.$(id)

data modify storage eden:temp village_name.color set from storage eden:database color.village.cherry_grove
