...
execute if data storage eden:settings mob_settings.shulker{drown:"disabled"} run tag @s add eden.settings.drown.disabled
execute if data storage eden:settings mob_settings.shulker{burn:"disabled"} run attribute @s minecraft:burning_time base set 0
