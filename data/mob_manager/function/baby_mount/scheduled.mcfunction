...
execute as @e[type=#mob_manager:valid_for_keep_baby,tag=mob_manager.settings.perma_baby] unless predicate mob_manager:entity/has_vehicle run function mob_manager:baby_mount/release