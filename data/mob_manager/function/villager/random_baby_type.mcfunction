...
execute if predicate {"type":"minecraft:int_value_check","value":{"type":"minecraft:storage","storage":"eden:temp","path":"mob_manager.villager.age"},"test":{"min":0}} run return fail
