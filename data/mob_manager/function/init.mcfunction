...
execute as @e[type=!#eden:invalid_for_settings,tag=!mob_manager.settings.applied] run function mob_manager:get_type

execute as @e[type=#eden:can_drown,tag=mob_manager.settings.drown.disabled] run data modify entity @s Air set value 300s
execute as @e[type=#eden:can_breed,tag=mob_manager.settings.breed.disabled] run function mob_manager:disable_breeding
