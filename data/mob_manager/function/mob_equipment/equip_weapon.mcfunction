$execute unless predicate {"type":"minecraft:random_chance","chance":$(equipchance)} run return fail
...
$execute unless predicate {"type":"minecraft:random_chance","chance":$(enchantment)} run item modify entity @s weapon.$(slot) mob_manager:enchant_with_levels
