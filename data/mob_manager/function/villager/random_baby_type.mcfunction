...
execute if predicate {"condition":"minecraft:value_check","value":{"type":"minecraft:storage","storage":"mob_manager:temp","path":"mob_manager.villager.age"},"range":{"min":0}} run return fail
