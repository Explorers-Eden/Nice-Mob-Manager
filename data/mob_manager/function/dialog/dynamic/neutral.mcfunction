...
{\
  ...
  "body":[\
    {\
      ...
      "description":{\
        "translate":"menu.mob_manager.neutral_mob_manager.description",\
        "fallback":"Configure Neutral Mob Settings:"\
      }\
    }\
  ],\
  "inputs":[\
  ...
  "yes":{\
    ...
    "action":{\
      ...
      "template":"function mob_manager:dialog/command_template/neutral {type:$(type)$(command_template)"\
    }\
  },\
  "no":{\
    "label":{\
