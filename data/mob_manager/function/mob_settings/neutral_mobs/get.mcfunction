...
$execute unless predicate {"type":"minecraft:int_value_check","value":{"type":"minecraft:storage","storage":"eden:settings","path":"mob_manager.$(type).scale_min"},"test":{"min":$(scale_max)}} store result storage eden:temp mob_manager.scale float 0.01 run random value $(scale_min)..$(scale_max)
$execute if predicate {"type":"minecraft:int_value_check","value":{"type":"minecraft:storage","storage":"eden:settings","path":"mob_manager.$(type).scale_min"},"test":{"min":$(scale_max)}} store result storage eden:temp mob_manager.scale float 0.01 run data get storage eden:settings mob_manager.$(type).scale_max
...
execute if predicate {"type":"minecraft:int_value_check","value":{"type":"minecraft:storage","storage":"eden:settings","path":"mob_manager.misc.babymountspawning"},"test":{"min":0.01}} as @s[type=#mob_manager:valid_for_baby_mount] at @s run function mob_manager:baby_mount/init with storage eden:settings mob_manager.misc
execute if predicate {"type":"minecraft:int_value_check","value":{"type":"minecraft:storage","storage":"eden:settings","path":"mob_manager.misc.immunezombie"},"test":{"min":0.01}} run function mob_manager:immune_zombification with storage eden:settings mob_manager.misc
execute if predicate {"type":"minecraft:int_value_check","value":{"type":"minecraft:storage","storage":"eden:settings","path":"mob_manager.misc.lefthanded"},"test":{"min":0.01}} run function mob_manager:lefthanded with storage eden:settings mob_manager.misc

execute if predicate {"type":"minecraft:int_value_check","value":{"type":"minecraft:storage","storage":"eden:settings","path":"mob_manager.mob_equipment.misc.mobheads"},"test":{"min":0.01}} as @s[type=#mob_manager:valid_for_playerheads] unless items entity @s armor.head * run function mob_manager:mob_equipment/mobheads/init with storage eden:settings mob_manager.mob_equipment.misc
execute if predicate {"type":"minecraft:int_value_check","value":{"type":"minecraft:storage","storage":"eden:settings","path":"mob_manager.mob_equipment.misc.playerheads"},"test":{"min":0.01}} as @s[type=#mob_manager:valid_for_playerheads] unless items entity @s armor.head * run function mob_manager:mob_equipment/playerheads/init with storage eden:settings mob_manager.mob_equipment.misc

execute if predicate {"type":"minecraft:int_value_check","value":{"type":"minecraft:storage","storage":"eden:settings","path":"mob_manager.mob_equipment.head.equipchance"},"test":{"min":0.01}} unless items entity @s armor.head * run function mob_manager:mob_equipment/equip_armor with storage eden:settings mob_manager.mob_equipment.head
execute if predicate {"type":"minecraft:int_value_check","value":{"type":"minecraft:storage","storage":"eden:settings","path":"mob_manager.mob_equipment.chest.equipchance"},"test":{"min":0.01}} unless items entity @s armor.chest * run function mob_manager:mob_equipment/equip_armor with storage eden:settings mob_manager.mob_equipment.chest
execute if predicate {"type":"minecraft:int_value_check","value":{"type":"minecraft:storage","storage":"eden:settings","path":"mob_manager.mob_equipment.legs.equipchance"},"test":{"min":0.01}} unless items entity @s armor.legs * run function mob_manager:mob_equipment/equip_armor with storage eden:settings mob_manager.mob_equipment.legs
execute if predicate {"type":"minecraft:int_value_check","value":{"type":"minecraft:storage","storage":"eden:settings","path":"mob_manager.mob_equipment.feet.equipchance"},"test":{"min":0.01}} unless items entity @s armor.feet * run function mob_manager:mob_equipment/equip_armor with storage eden:settings mob_manager.mob_equipment.feet
execute if predicate {"type":"minecraft:int_value_check","value":{"type":"minecraft:storage","storage":"eden:settings","path":"mob_manager.mob_equipment.mainhand.equipchance"},"test":{"min":0.01}} run function mob_manager:mob_equipment/equip_weapon with storage eden:settings mob_manager.mob_equipment.mainhand
execute if predicate {"type":"minecraft:int_value_check","value":{"type":"minecraft:storage","storage":"eden:settings","path":"mob_manager.mob_equipment.offhand.equipchance"},"test":{"min":0.01}} run function mob_manager:mob_equipment/equip_weapon with storage eden:settings mob_manager.mob_equipment.offhand
