...
function mob_manager:villager_names/get_data/swamp/copy_to_temp with storage eden:temp villager_names.swamp.id

data modify storage eden:temp villager_names.swamp.color set from storage eden:database color.villager.swamp

function mob_manager:villager_names/set_name with storage eden:temp villager_names.swamp