...
data modify storage eden:temp trader.treasurebook.treasure_book set from entity @n[type=item,distance=..2,predicate=eden:entity/is_enchanted_book] Item.components
